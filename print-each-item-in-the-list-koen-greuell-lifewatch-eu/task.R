...
make_option(c("--radar_locations"), action="store", default=NA, type="character", help="my description"),
...
print("Retrieving radar_locations")
var = opt$radar_locations
print(var)
var_len = length(var)
print(paste("Variable radar_locations has length", var_len))

print("------------------------Running var_serialization for radar_locations-----------------------")
print(opt$radar_locations)
radar_locations = var_serialization(opt$radar_locations)
print("---------------------------------------------------------------------------------")
