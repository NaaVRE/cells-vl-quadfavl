...
radar_locations <- list("deneu", "dealt")
# capturing outputs
print('Serialization of radar_locations')
file <- file(paste0('/tmp/radar_locations_', id, '.json'))
writeLines(toJSON(radar_locations, auto_unbox=TRUE), file)
close(file)
